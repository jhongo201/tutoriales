...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('Error GET /api/catalogs/user-profiles:', error)
...
export const POST = withAuth(async (req) => {
  try {
    ...
    const result = await db.request()
      ...
      .query(`
        INSERT INTO tutorial_user_profiles (code, label, display_order, active)
        OUTPUT INSERTED.id
    ...
    console.error('Error POST /api/catalogs/user-profiles:', error)
