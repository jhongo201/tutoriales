...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('Error GET /api/catalogs/content-types:', error)
...
export const POST = withAuth(async (req) => {
  try {
    ...
    const result = await db.request()
      ...
      .query(`
        INSERT INTO tutorial_content_types (code, label, display_order, active)
        OUTPUT INSERTED.id
    ...
    console.error('Error POST /api/catalogs/content-types:', error)
